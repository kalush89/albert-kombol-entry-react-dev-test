                            ...
                            case 'minusIcon':
                                return (
                                    <div className="minus-icon">
                                        <svg  width="14" height="1" viewBox="0 0 17 1" fill="none" xmlns="http://www.w3.org/2000/svg">   
                                        <path d="M1 0.5H16" stroke="#1D1F22" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
                                        </svg>
                                    </div>
                                    )
                            ...
                            case 'plusIcon':
                                return (
                                    <div className="plus-icon">
                                        ...
                                        <path 
                                        d='M8,-1 V16 M-1,8 H16'
                                        //d="M1, 0.5 H16 M0.5, 1 V16" 
                                        stroke="#1D1F22" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
                                        />
                                        </svg>
                                    </div>
                                    )
                            ...
                            case 'cancelIcon':
                                return (
                                    <div className='cancel-icon'>
                                        ...
                                        <path d="M16 16 36 36 M36 16 16 36" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
                                    )
                            default:
